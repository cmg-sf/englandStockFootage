      ...
      <div className="App">
        ...
        <div id="vidtop-content">
          ...
          <div className="interact-box">
            <img src={logo} alt=""/>
            <h1><span style={{color: 'rgb(188, 52, 38)'}}>EnglandStock</span>Footage.com</h1>
        ...
        <div className="info-sec">
          <section>
            ...
            <h4 className="sub-banner">EnglandStockFootage.com is a division of <a style={{textDecoration:'none', color: '#999'}} href="https://stockfootage.com/">StockFootage.com</a></h4>
          </section>
